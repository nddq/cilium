...
```
  ...
  -h, --help                                                      help for cilium-agent
      ...
      --tofqdns-server-port int                                   Global port on which the in-agent grpc server for fqdn should listen on.(deprecated, use standalone-dns-proxy-server-port instead) (default 40045)
