...
var NamespaceIndex = statedb.Index[ServiceAccount, string]{
...
var NamespacedNameIndex = statedb.Index[ServiceAccount, string]{
...
func NewServiceAccountTable(jg job.Group, db *statedb.DB, cs client.Clientset, zcfg config.ZtunnelConfig) (statedb.Table[ServiceAccount], error) {
