...
var _ certificateauthority.Client = &Client{}

func NewClient(k8sClient k8sClient.Clientset, clientCfg ClientConfig, ztunnelCfg config.ZtunnelConfig, logger *slog.Logger) certificateauthority.Client {
	client := &Client{
		clientCfg:  clientCfg,
...
func (c *Client) Upsert(ctx context.Context, ids ...*certificateauthority.ID) error {
	if !c.ztunnelCfg.Enabled {
		return nil
	}
	if !c.initialized {
...
func (c *Client) Delete(ctx context.Context, entries ...*certificateauthority.ID) error {
	if !c.ztunnelCfg.Enabled {
...
func (c *Client) listEntries(ctx context.Context, id *certificateauthority.ID) (*entryv1.ListEntriesResponse, error) {
